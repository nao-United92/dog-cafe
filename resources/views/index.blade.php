...
<section class="bg-gray-100">
  <div class="container mx-auto py-40 relative">
    <h1 class="mt-2 text-4xl font-bold font-heading text-center">わんちゃんに癒やしてもらいませんか？</h1>
    <p class="text-center pt-5">わんちゃんの可愛い仕草、自由気ままな雰囲気を見ることはもちろん、<br>
      ただ同じ空間にいるだけでも癒やされます<br>
      当店自慢のフワッフワのわんちゃんに触れ合うことで「幸せホルモン」が補給しませんか？</p>
    ...
    <div class="w-full lg:w-1/3 p-3">
      <div class="bg-gray-100 rounded shadow">
        <div class="flex py-10 px-6">
          ...
          <div class="ml-4 w-56">
            <h3 class="mb-2 text-xl font-heading text-left text-blue-500">わんちゃんの体調管理</h3>
...
<section class="mt-24 container mx-auto">
  ...
  <ul class="mt-8">
    <li class="flex py-4 border-t border-b"><p class="font-bold w-40">2022. 3. 4（水）</p><p class="bg-gray-100 text-gray-400 px-3">カテゴリ</p><a href="#" class="ml-4 text-blue-500">ドッグフードなどの販売をはじめました</a></li>
...
<section class="mt-24">
  <div class="container mx-auto">
    ...
    <h2 class="mt-2 font-bold font-heading text-center text-3xl">ほぼ毎日お店でわんちゃんの様子をお届け！！</h2>

    <div class="my-8 pb-4 border-b">
      <p class="text-lg text-left">カテゴリ / わんちゃん</p>
      <ul class="flex text-center pt-2">
        ...
        <li class="bg-gray-100 text-gray-400 py-1 px-3 mr-3"><a href="#">カテゴリ</a></li>
        <li class="bg-gray-100 text-gray-400 py-1 px-3 mr-3"><a href="#">＃わんちゃん</a></li>
        <li class="bg-gray-100 text-gray-400 py-1 px-3 mr-3"><a href="#">＃わんちゃん</a></li>
        <li class="bg-gray-100 text-gray-400 py-1 px-3"><a href="#">＃わんちゃん</a></li>
      </ul>
    </div>
      ...
      <article class="w-full md:w-1/2 lg:w-1/3 p-3">
        <div class="border rounded-lg overflow-hidden shadow">
          <div class="relative h-52">
            ...
            <a href="#"><img class="w-full h-full object-cover" src="/images/placeholders/blogs/playing.jpeg" alt=""></a>
            <time class="text-xs text-gray-500 text-right pr-2 pt-2">2022.3.12</time>
          </div>
          <div class="pt-2 pb-4 px-4">
            <a href="#">
              <h1 class="mb-2 text-2xl font-semibold font-heading text-left">ふれあいの様子</h1>
              <p class="mb-6 text-gray-500 leading-relaxed text-left truncate">カフェ内でわんちゃん達とふれ合って存分に癒されてください！</p>
            </a>
            <div class="flex justify-between">
              <ul class="flex">
                <li class="bg-gray-100 text-gray-400 text-xs mr-2 py-1 px-2">＃わんちゃん</li>
                <li class="bg-gray-100 text-gray-400 text-xs py-1 px-2 mr-2">＃わんちゃん</li>
                <li class="bg-gray-100 text-gray-400 text-xs py-1 px-2">＃わんちゃん</li>
              </ul>
        ...
        <div class="border rounded-lg overflow-hidden shadow">
          ...
          <div class="pt-2 pb-4 px-4">
            <a href="#">
              ...
              <p class="mb-6 text-gray-500 leading-relaxed text-left truncate">実はドッグカフェはリモートワークやコワーキングとしても大活躍....</p>
            </a>
            <div class="flex justify-between">
              <ul class="flex">
                <li class="bg-gray-100 text-gray-400 text-xs mr-2 py-1 px-2">＃わんちゃん</li>
        ...
        <div class="border rounded-lg overflow-hidden shadow">
          ...
          <div class="pt-2 pb-4 px-4">
            ...
            <div class="flex justify-between">
              ...
              <p class="font-medium font-semibold">茅野</p>
            </div>
          </div>
        </div>
      </article>
  ...
  <div class="container mx-auto">
    ...
    <div class="md:flex justify-center">
      ...
      <div class="text-left lg:ml-8 px-8">
        <p class="font-bold text-3xl pb-5">Dog Cafe ~ Noah ~</p>
        <dl>

    ...
    <div class="mt-8">
      ...
      <form action="{{ route('contact') }}" method="post">
        ...
        <div class="mb-4">
          ...
          <input id="phone" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border" type="text" placeholder="例）0312345678" name="phone" value="{{ old('name_phone') }}">
        </div>
        <div class="mb-4">

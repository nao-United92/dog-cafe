...
<html lang="ja">
<head>
    <title>@yield('title', 'Dog Cafe ~ Noah ~')</title>
    <meta charset="utf-8">
...
<header>
    <div class="container px-4 mx-auto">
        <nav class="flex items-center justify-between py-6">
            <a class="text-3xl font-semibold leading-none" href="/">Dog Cafe ~ Noah ~</a>
            <ul class="hidden lg:flex ml-12 mr-auto space-x-12">
                ...
                <li><a class="text-sm text-blueGray-400 hover:text-blueGray-500" href="#">わんちゃんたち</a></li>
...
<footer class="bg-black">
    <div class="px-4 container mx-auto p-10 flex justify-between">
        <div class="text-white text-left">
            <h2 class="text-xl font-semibold">Dog Cafe ~ Noah ~</h2>
            <p>〒123-4567</p>
        ...
        <ul class="text-white text-left hidden md:flex flex-wrap flex-col h-12 md:w-128">
            ...
            <li class="ml-6"><a href="#" class="hover:underline">わんちゃんたち</a></li>

...
<section class="bg-gray-100">
  <div class="container mx-auto">
    <p class="text-left px-4 pt-2"><a href="#" class="text-blue-600 hover:underline">ホーム</a>&gt;わんちゃんたち</p>
    ...
    <div class="flex flex-wrap">
        <div class="w-full md:w-1/2 py-5 md:px-5">
            <div class="px-6 bg-white shadow rounded h-full py-10">
                <div class="flex items-center mb-4">
                    <img class="h-16 w-16 rounded-full object-cover" src="/images/placeholders/dogs/dog1.jpg" alt="">
                    <div class="pl-4">
        ...
        <div class="w-full md:w-1/2 py-5 md:px-5">
            <div class="px-6 py-10 bg-white shadow rounded h-full">
                <div class="flex items-center mb-4">
                    <img class="h-16 w-16 rounded-full object-cover" src="/images/placeholders/dogs/dog2.jpg" alt="">
                    <div class="pl-4">
